...
public class MemberManager {
	...
	public void signUpMembers() {
		...
		MemberDTO[] members = new MemberDTO[5];	// MemberDTO[] 타입의 객체를 5개의 길이에 배열 공간을 초기화 함.
...
//		MemberSelectManager selectManager = new MemberSelectManager();
//		MemberDTO[] selectedMembers = selectManager.selectAllMembers();
		MemberDTO[] selectedMembers = new MemberSelectManager().selectAllMembers();	// 변수 재사용의 목적을 위해서 클래스 타입의 객체를 생성하지 않고 MemberDTO[]타입의 객체를 생성한거다. 		
